    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white border-r border-gray-100 hidden md:flex flex-col sticky top-0 h-screen">
            ...
            <nav class="flex-grow px-4 space-y-1.5 mt-4">
                ...
                {{-- Publikasi / Reports --}}
                <div class="pt-6 pb-2 px-3 text-[10px] font-black uppercase text-gray-400 tracking-[0.2em]">Laporan & Arsip</div>
                <x-nav-link :href="route('admin.publikasi.index')" :active="request()->routeIs('admin.publikasi.*')" icon="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                    Laporan Publikasi
                </x-nav-link>
            </nav>
